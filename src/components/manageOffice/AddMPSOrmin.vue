    ...
    <div class="order">
      <div class="rating-header py-3">
        <div class="d-flex align-items-center justify-content-between">
          <h4>Manage Oriental Mindoro Offices</h4>
  ...
  methods: {
    ...
    async saveColumn() {
      try {
        ...
        const response = await axios.post("/updateColumnOrmin", {
    ...
    async confirmDelete() {
      try {
        const response = await axios.post("/deleteColumnOrmin", {
    ...
    async insertColumnRmfb() {
      try {
        ...
        const response = await axios.post("/addColumnOrmin", {
    ...
    async getOfficePPO() {
      try {
        const response = await axios.get("/displayColumnsOrmin");
