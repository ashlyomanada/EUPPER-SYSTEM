    ...
    <div class="order">
      <div class="rating-header">
        <div>
          ...
          <h4 class="head-subtitle">New Office for Oriental Mindoro</h4>
        </div>
      </div>
      <form class="form" @submit.prevent="addColumnOrmin">
        <input
          type="text"
          ...
          required
        />
        <button type="submit">Add Oriental Mindoro Office</button>
      </form>
    </div>
  </div>
