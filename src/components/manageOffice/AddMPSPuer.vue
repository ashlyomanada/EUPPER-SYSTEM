    ...
    <div class="order">
      <div class="rating-header py-3">
        <div class="d-flex align-items-center justify-content-between">
          <h4>Manage Puerto Princesa Offices</h4>
  ...
  methods: {
    ...
    async saveColumn() {
      try {
        ...
        const response = await axios.post("/updateColumnPuer", {
    ...
    async confirmDelete() {
      try {
        const response = await axios.post("/deleteColumnPuer", {
    ...
    async insertColumnRmfb() {
      try {
        ...
        const response = await axios.post("/addColumnPuer", {
    ...
    async getOfficePPO() {
      try {
        const response = await axios.get("/displayColumnsPuer");
