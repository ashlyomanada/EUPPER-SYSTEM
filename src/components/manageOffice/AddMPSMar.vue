    ...
    <div class="order">
      <div class="rating-header py-3">
        <div class="d-flex align-items-center justify-content-between">
          <h4>Manage Marinduque Offices</h4>
  ...
  methods: {
    ...
    async saveColumn() {
      try {
        ...
        const response = await axios.post("/updateColumnMar", {
    ...
    async confirmDelete() {
      try {
        const response = await axios.post("/deleteColumnMar", {
    ...
    async insertColumnRmfb() {
      try {
        ...
        const response = await axios.post("/addColumnMar", {
    ...
    async getOfficePPO() {
      try {
        const response = await axios.get("/displayColumnsMar");
