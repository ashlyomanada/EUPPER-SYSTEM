  ...
  methods: {
    ...
    async saveColumn() {
      try {
        ...
        const response = await axios.post("/updateColumnPal", {
    ...
    async confirmDelete() {
      try {
        const response = await axios.post("/deleteColumnPal", {
    ...
    async insertColumnRmfb() {
      try {
        ...
        const response = await axios.post("/addColumnPal", {
    ...
    async getOfficePPO() {
      try {
        const response = await axios.get("/displayColumnsPal");
