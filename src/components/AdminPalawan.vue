      ...
      <div class="head">
        <div class="head-options">
          <div style="text-align: center">
            ...
            <h4>Municipalities of Palawan</h4>
          </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          <p>
            Are you sure do you want to generate an Excel Report for Palawan?,
  ...
  >
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          <p>
            Are you sure do you want to generate an PDF Report for Palawan?,
            please check if all users rated!
          </p>
...
export default {
  ...
  methods: {
    ...
    confirmationGenerateExcel() {
      const modalElement = document.getElementById("palawanExcelConfirmation");
      const modalInstance = new Modal(modalElement);
      modalInstance.show();
    },
    confirmationGeneratePdf() {
      const modalElement = document.getElementById("palawanPdfConfirmation");
      const modalInstance = new Modal(modalElement);
      modalInstance.show();
    },
    ...
    async fetchColumns() {
      try {
        const response = await axios.get("/getColumnNamePal");
    ...
    async getUsersRate() {
      try {
        ...
        const response = await axios.post("/getUsersRatePal", {
          Month: currentMonth,
          Year: currentYear,
        });
    ...
    async getUsersRateByMonth() {
      try {
        const response = await axios.post("/getUsersRatePalByMonth", {
          Month: this.month,
          Year: this.year,
        });
...
>>>>>>> 65fa85e1ad0a2ac0cc5b6c011d29033118f1499f
        ...
        const fileName = `Palawan_Report_${this.month}_${this.year}.xlsx`;
    ...
    generatePdf() {
      ...
      axios
        ...
        .then((response) => {
          ...
          a.href = url;
          a.download = `Palawan_Report_${this.month}_${this.year}.pdf`;
          document.body.appendChild(a);
          a.click();
          window.URL.revokeObjectURL(url);

          const modalElement = document.getElementById(
            "palawanPdfConfirmation"
          );
          const modalInstance =
            Modal.getInstance(modalElement) || new Modal(modalElement);
