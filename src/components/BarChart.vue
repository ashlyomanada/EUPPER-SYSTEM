<template>
  <div>
    <div class="chart-container">
      ...
      <label class="chartName" for="">PPO Rates</label>
    </div>

    <div class="chart-container">
      <canvas ref="groupedBarChartRMFB"></canvas>
      <label class="chartName" for="">RMFB Rates</label>
    </div>

    <div class="chart-container">
      <canvas ref="groupedBarChartOccidental"></canvas>
      <label class="chartName" for="">Occidental Mindoro Rates</label>
    </div>

    <div class="chart-container">
      <canvas ref="groupedBarChartOriental"></canvas>
      <label class="chartName" for="">Oriental Mindoro Rates</label>
    </div>

    <div class="chart-container">
      <canvas ref="groupedBarChartMarinduque"></canvas>
      <label class="chartName" for="">Marinduque Rates</label>
    </div>

    <div class="chart-container">
      <canvas ref="groupedBarChartRomblon"></canvas>
      <label class="chartName" for="">Romblon Rates</label>
    </div>

    <div class="chart-container">
      <canvas ref="groupedBarChartPalawan"></canvas>
      <label class="chartName" for="">Palawan Rates</label>
    </div>

    <div class="chart-container">
      <canvas ref="groupedBarChartPuerto"></canvas>
      <label class="chartName" for="">Puerto Rates</label>
    </div>
  </div>
</template>
