      ...
      <div class="head">
        <div class="head-options">
          <div style="text-align: center">
            ...
            <h4>Municipalities of Puerto Princesa</h4>
          </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          <p>
            Are you sure do you want to generate an Excel Report for Puerto
            Princesa?, please check if all users rated!
          </p>
  ...
  >
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          <p>
            Are you sure do you want to generate an PDF Report for Puerto
            Princesa?, please check if all users rated!
          </p>
...
export default {
  ...
  methods: {
    ...
    confirmationGeneratePdf() {
      const modalElement = document.getElementById("puertoPdfConfirmation");
      const modalInstance = new Modal(modalElement);
      modalInstance.show();
    },
    ...
    async getUsersRate() {
      try {
        ...
        const response = await axios.post("/getUsersRatePuer", {
          Month: currentMonth,
          Year: currentYear,
        });
    ...
    async getUsersRateByMonth() {
      try {
        const response = await axios.post("/getUsersRatePuerByMonth", {
          Month: this.month,
          Year: this.year,
        });
    ...
    async generatePuerReport() {
      try {
        ...
        const fileName = `Puerto_Princesa_Report_${this.month}_${this.year}.xlsx`;
    ...
    generatePdf() {
      ...
      axios
        ...
        .then((response) => {
          ...
          a.href = url;
          a.download = `Puerto_Princesa_Report_${this.month}_${this.year}.pdf`;
