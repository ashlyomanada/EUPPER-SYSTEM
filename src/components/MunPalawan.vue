    ...
    <div class="order">
      <div class="rating-header">
        <div>
          ...
          <h4 class="head-subtitle">Municipalities of Palawan</h4>
        </div>
      </div>
          ...
          <div class="rate-date-container">
            ...
            <div class="date-container">
              ...
              <select class="month" v-model="Municipality" required>
                <option value="Aborian">Aborian</option>
                <option value="Agutaya">Agutaya</option>
                <option value="Arceli">Arceli</option>
                <option value="Balacbac">Balacbac</option>
                <option value="Bataraza">Bataraza</option>
                <option value="BrookesmPoint">BrookesmPoint</option>
                <option value="Busuanga">Busuanga</option>
                <option value="Cagayancilo">Cagayancilo</option>
                <option value="Coron">Coron</option>
                <option value="Culion">Culion</option>
                <option value="Cuyo">Cuyo</option>
                <option value="Dumaron">Dumaron</option>
