    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          <p>
            Are you sure do you want to generate an Excel Report for Oriental
  ...
  >
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          <p>
            Are you sure do you want to generate an PDF Report for Oriental
            Mindoro?, please check if all users rated!
          </p>
...
export default {
  ...
  methods: {
    ...
    confirmationGenerateExcel() {
      const modalElement = document.getElementById("orientalExcelConfirmation");
      const modalInstance = new Modal(modalElement);
      modalInstance.show();
    },
    confirmationGeneratePdf() {
      const modalElement = document.getElementById("orientalPdfConfirmation");
      const modalInstance = new Modal(modalElement);
      modalInstance.show();
    },
    ...
    async getUsersRate() {
      try {
        ...
        const response = await axios.post("/getUsersRateOrmin", {
          Month: currentMonth,
          Year: currentYear,
        });
    ...
    async getUsersRateByMonth() {
      try {
        const response = await axios.post("/getUsersRateOrminByMonth", {
          Month: this.month,
          Year: this.year,
        });
    ...
    generatePdf() {
      ...
      axios
        ...
        .then((response) => {
          ...
          a.href = url;
          a.download = `Oriental_Mindoro_Report_${this.month}_${this.year}.pdf`;
          document.body.appendChild(a);
          a.click();
          window.URL.revokeObjectURL(url);

          const modalElement = document.getElementById(
            "orientalPdfConfirmation"
          );
          const modalInstance =
            Modal.getInstance(modalElement) || new Modal(modalElement);
