    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          <p>
            Are you sure do you want to generate an Excel Report for RMFB?,
  ...
  >
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          <p>
            Are you sure do you want to generate an PDF Report for RMFB?, please
...
export default {
  ...
  methods: {
    ...
    confirmationGenerateExcel() {
      const modalElement = document.getElementById("rmfbExcelConfirmation");
      const modalInstance = new Modal(modalElement);
      modalInstance.show();
    },
    confirmationGeneratePdf() {
      const modalElement = document.getElementById("rmfbPdfConfirmation");
      const modalInstance = new Modal(modalElement);
      modalInstance.show();
    },
