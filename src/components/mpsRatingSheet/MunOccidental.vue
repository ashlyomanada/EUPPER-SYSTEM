...
export default {
  data() {
    return {
      ...
      isSubmit: false,
      userName: "",
      level: "Municipalities of Occidental Mindoro",
    };
  },
  ...
  methods: {
    ...
    async saveRating() {
      try {
        ...
        const response = await axios.post("/insertDataOcci", data);
        this.sentNotif();
        const modalElement = document.getElementById("occidentalSuccessModal");
