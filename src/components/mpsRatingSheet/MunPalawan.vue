...
export default {
  data() {
    return {
      ...
      isSubmit: false,
      userName: "",
      level: "Municipalities of Palawan",
    };
  },
  ...
  methods: {
    ...
    async saveRating() {
      try {
        ...
        const response = await axios.post("/insertDataPal", data);
        this.sentNotif();
        const modalElement = document.getElementById("palawanSuccessModal");
