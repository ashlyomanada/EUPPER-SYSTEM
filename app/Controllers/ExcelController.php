...
class ExcelController extends ResourceController
{
    public function generateExcelReport()
    {
        ...
        $sheet->setCellValue('A4', $levelName);
        $sheet->getStyle('A4')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);

        // Set background color for 'Unit Performance Evaluation Rating'
        $sheet->mergeCells('A5:P5');
        $sheet->setCellValue('A5', 'Unit Performance Evaluation Rating');
        $sheet->getStyle('A5')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        $sheet->getStyle('A5')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
        
        // Set background color for 'OFFICE/UNIT'
        ...
        $sheet->getStyle('A7')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
        
        $sheet->getStyle('A6:P6')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
        // Set background color for 'Operational (60%)'
        $sheet->mergeCells('B6:E6');
        $sheet->setCellValue('B6', 'Operational (60%)');
        $style = $sheet->getStyle('B6');
        $alignment = $style->getAlignment();
        $alignment->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        $sheet->getStyle('B6')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
        
        // Set background color for 'Administrative (40%)'
        $sheet->mergeCells('G6:M6');
        $sheet->setCellValue('G6', 'Administrative (40%)');
        $style = $sheet->getStyle('G6');
        $alignment = $style->getAlignment();
        $alignment->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        $sheet->getStyle('G6')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
        
        // Set background color for 'Total Percentage Ratings'
        ...
        $sheet->getStyle('O7')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
        ...
        $sheet->getStyle('P7')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');        
        ...
        // Loop for $userOffices1 (Operational)
        $colIndex = 2;
        foreach ($userOffices1 as $office) {
            ...
            $sheet->getStyleByColumnAndRow($colIndex, 7)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
            $colIndex++;
        }

        // Loop for $additionalOperational
        $colIndexAd = 2;
        foreach ($additionalOperational as $office) {
            ...
            // Set background color to yellow
            $sheet->getStyleByColumnAndRow($colIndexAd, 8)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
            $colIndexAd++;
        }
        ...
        // Set background color to yellow for '60%'
        $sheet->getStyleByColumnAndRow($colIndex, 7)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');

        // Loop for $userOffices2 (Administrative)
        $colIndex2 = 7;
        foreach ($userOffices2 as $office) {
            ...
            // Set background color to yellow
            $sheet->getStyleByColumnAndRow($colIndex2, 7)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
            $colIndex2++;
        }

        // Loop for $additionalAdministrative
        $colIndexOp = 7;
        foreach ($additionalAdministrative as $office) {
            ...
            // Set background color to yellow
            $sheet->getStyleByColumnAndRow($colIndexOp, 8)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
            $colIndexOp++;
        }

           // Merge cells for the "40%" header and set value
           ...
           // Set background color to yellow for '40%' (N7:N8)
           $sheet->getStyle('N7:N8')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
